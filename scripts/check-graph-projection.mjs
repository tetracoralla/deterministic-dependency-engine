...
const dependency = "file:vendor/openadam-graph-projection-0.3.0.tgz";
const filename = "openadam-graph-projection-0.3.0.tgz";
...
const projection = await import("@openadam/graph-projection/semantic");
assert.equal(projection.SEMANTIC_GRAPH_VERSION, 1);
assert.equal(typeof projection.sliceSemanticGraph, "function");
